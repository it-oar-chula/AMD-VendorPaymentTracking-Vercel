...
- ✅ ค้นหาด้วยเลข Invoice แบบตรงทั้งช่อง
- ✅ ค้นหาด้วยชื่อผู้รับเงิน/ชื่อบริษัทแบบตรงทั้งช่อง
- ✅ เก็บระบบค้นหาเดิมแบบ partial match ไว้ในโค้ด แต่ปิดไว้ก่อน (`SEARCH_MODE=partial`)
...
**พฤติกรรมจริงของโค้ด:**
- ค่า default ค้นหาแบบ strict match
- ถ้าคำค้นหาตรงกับ `Invoice_Number` ทั้งช่อง จะพบรายการนั้น
- ถ้าคำค้นหาตรงกับ `ชื่อผู้รับเงิน` ทั้งช่อง จะพบรายการนั้น
- ระบบสร้าง `Invoice_Number` เพิ่มจากคำแรกของ `รายละเอียดของรายการ`
- ระบบค้นหาเดิมแบบ partial match จาก `ชื่อผู้รับเงิน` และ `รายละเอียดของรายการ` ยังอยู่ แต่ปิดไว้ก่อน (`SEARCH_MODE=partial`)
